...
namespace GeolocationAPI.Repositories
{
    ...
    {
        public ConfigurationRepository(SAPConnector connector)
         : base(connector)
        {
        }

        public async Task<IEnumerable<Configuration>> RetrieveConfigurations()
        {
            const string requestUrl = @"b1s/v1/U_VS_PD_OPDS";
            ...
            return response.ContentCollectionToSpecific<Configuration[]>();
        }
    }
}
