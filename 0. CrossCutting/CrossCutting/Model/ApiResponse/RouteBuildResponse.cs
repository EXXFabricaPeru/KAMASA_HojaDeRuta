...
namespace Exxis.Addon.HojadeRutaAGuia.CrossCutting.Model.ApiResponse
{
    [Serializable]
    public class RouteBuildResponse
    {
        ...
        [JsonProperty("auxiliaryExtra")]
        public string AuxiliaryIdExtra { get; set; }
